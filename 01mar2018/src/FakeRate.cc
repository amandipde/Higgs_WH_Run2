...
void FakeRate::bookHistograms() 
{
  ...
  new TH1F("pt_mu1_Wjets_CR", "mu1 Pt in the Wjets CR",140, 0, 140); 
...
if (muo1.pt <= 20 || muo2.pt <= 10) return;               
...
if (mass1 > 40 )
{
AnaUtil::fillHist1D("pt_mu1_Wjets_CR", muo1.pt, puevWt_);
int nvtx = vtxList.size();
