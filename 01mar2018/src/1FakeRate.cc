...
void FakeRate::bookHistograms() 
{
  ...
  new TH1D("evcount", "Selected event counter", 12, 1, 13);
  ...
  new TH1F("npv_DY", "npv distribution in the DY Region", 50, 0, 50);
  new TH1F("Relative Isolation of muons", "Relative isolation of muons in DY region", 100, 0, 10);

  new TH1F("MT_Mu_Met_Wjet","transverse mass plot for Muon and MET in Wjet Region", 140, 0, 140);
...
void FakeRate::JetToTauFakeWJets()
{
  ...
  AnaUtil::fillHist1D("MT_Mu_Met_Wjet", mass1, puevWt_); //Plot for Mt for mu and MET in Wjet region 

 if (mass1 <= 40) return;//changed to 40->50 to improve the purity of control region                                                          
